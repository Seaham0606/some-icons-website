...
}`,...t.parameters?.docs?.source},description:{story:"`InputSection` label-row lead: 12×12 glyph (`icon-2xs`), no inset.",...t.parameters?.docs?.description}}};const I=["Default","Filled","AccentColor","LargerFrame","InputSlot","InputSectionLead"];export{s as AccentColor,r as Default,c as Filled,t as InputSectionLead,i as InputSlot,a as LargerFrame,I as __namedExportsOrder,y as default};
