...
}`,...t.parameters?.docs?.source},description:{story:"`InputSection` label-row leading/trailing: 12×12 glyph (`icon-2xs`), no inset.",...t.parameters?.docs?.description}}};const x=["Default","Filled","AccentColor","LargerFrame","InputSlot","InputSectionLeading"];export{s as AccentColor,r as Default,c as Filled,t as InputSectionLeading,i as InputSlot,a as LargerFrame,x as __namedExportsOrder,S as default};
