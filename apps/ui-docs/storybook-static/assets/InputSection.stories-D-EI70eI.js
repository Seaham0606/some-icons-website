...
}`,...o.parameters?.docs?.source},description:{story:"Uses the default CDN (`design-system` package `someIconsCdnBaseUrl`). Requires network.",...o.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
