...
}`,...a.parameters?.docs?.source},description:{story:"Expand/collapse trailing control fades in while the pointer is inside the section (pointer enter/leave on shell). Requires network.",...a.parameters?.docs?.description}}};const C=["WithLeadingIcon","LeadingIconFilled","WithLeadingAndTrailing","WithLeadingColor","WithCustomLeadingSlot","WithCustomContent","LabelOnly","WithoutContentSlot","WithoutLabel","Collapsible"];export{a as Collapsible,c as LabelOnly,t as LeadingIconFilled,s as WithCustomContent,r as WithCustomLeadingSlot,l as WithLeadingAndTrailing,i as WithLeadingColor,n as WithLeadingIcon,d as WithoutContentSlot,m as WithoutLabel,C as __namedExportsOrder,f as default};
