import{j as d}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-CBfxnU_t.js";import{T as t}from"./index-DYD40Rep.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"ThemeButton",component:t,tags:["autodocs"],argTypes:{mode:{control:"select",options:["light","dark"]},onToggle:{action:"toggle"}}},e={args:{mode:"light",onToggle:()=>{}}},o={args:{mode:"dark",onToggle:()=>{}}},r={render:function(){const[a,s]=c.useState("light");return d.jsx(t,{mode:a,onToggle:()=>s(n=>n==="dark"?"light":"dark")})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    mode: "light",
    onToggle: () => {}
  }
