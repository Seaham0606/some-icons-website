...
/** SVG file / ZIP export; `code` copies a snippet (size still comes from export UI). */
export const ASSET_EXPORT_FORMATS = ['svg'] as const
export type AssetExportFormat = (typeof ASSET_EXPORT_FORMATS)[number]

export const EXPORT_FORMATS = ['svg', 'code'] as const
